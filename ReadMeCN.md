...
以下工具目前处于**实验阶段**，尚未经过充分测试，**不建议用于生产环境**：

- **nu2cpp**: Nu语言到C++的转换工具
- **nu2ts**: Nu语言到TypeScript的转换工具

这些工具正在积极开发中，可能存在以下问题：
- 语法转换不完整或不准确
- 类型系统映射存在缺陷
- 生成的代码可能无法编译或运行
- API和行为可能随时发生变化
...
**推荐用于生产环境：**
- ✅ **rust2nu** / **nu2rust**: 生产就绪，经过充分测试
- ✅ **cargo2nu** / **nu2cargo**: 生产就绪，支持完整工作空间

如果您在使用实验性工具时遇到问题，欢迎提交Issue反馈。